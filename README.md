...
[![CircleCI](https://circleci.com/gh/mbjoseph/eddi/tree/master.svg?style=svg)](https://circleci.com/gh/mbjoseph/eddi/tree/master)
...
devtools::install_github("mbjoseph/eddi")
```
